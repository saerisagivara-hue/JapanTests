...
const N3_LESSONS: Lesson[] = [
  {
    id: "n3-narezki-quote", level: "N3",
    titleRu: "Цитата (разговорный стиль): 俺 / お前 / 〜てない",
    descriptionRu: "Короткий фрагмент в разговорном стиле. Лексика: 俺, お前, 怒ってない, 憎む. Грамматика: 〜ていない → 〜てない.",
    video: { type: "remote", src: "https://archive.org/download/japanese-trainer-narezki/narezki-03.mp4" },
    subtitles: [
      { startSec: 5, endSec: 10, ja: "俺は今、お前のために怒ってない。", furigana: "おれ は いま、おまえ の ため に おこってない。" },
      { startSec: 10, endSec: 13, ja: "誰も憎んじゃいない。", furigana: "だれ も にくんじゃいない。" },
      { startSec: 13, endSec: 20, ja: "今はただただ、この世界が心地いい。", furigana: "いま は ただただ、この せかい が ここちいい。" },
    ],
    questions: [
      { id: "n3q01", kind: "listening_mcq", atSec: 11, promptRu: "「俺」— это:", optionsRu: ["Очень вежливое «я»", "Разговорное «я» (мужское)", "«ты»", "«он»"], correctIndex: 1 },
      { id: "n3q02", kind: "listening_mcq", atSec: 11, promptRu: "「お前」— это:", optionsRu: ["Вежливое «вы»", "Разговорное «ты» (может звучать грубо)", "«мы»", "«они»"], correctIndex: 1 },
      { id: "n3q03", kind: "listening_mcq", atSec: 11, promptRu: "Грамматика: «怒ってない」это сокращение от:", optionsRu: ["怒っています", "怒っていない", "怒らない", "怒れない"], correctIndex: 1, explanationRu: "Разговорно: 〜ていない → 〜てない." },
      { id: "n3q04", kind: "listening_mcq", atSec: 14, promptRu: "「誰も〜ない」означает:", optionsRu: ["Кто‑то делает", "Никто не делает", "Все делают", "Всегда делает"], correctIndex: 1, explanationRu: "誰も + отрицание = «никто»." },
      { id: "n3q05", kind: "kanji_translate", atSec: 14, promptRu: "Переведите「世界」.", kanji: "世界", acceptedRu: ["мир", "вселенная"] },
      { id: "n3q06", kind: "kanji_translate", atSec: 14, promptRu: "Переведите「心地いい」.", kanji: "心地", acceptedRu: ["комфорт", "приятно", "уютно"] },
      { id: "n3q07", kind: "word_order", atSec: 11, promptRu: "Соберите: «Я сейчас не злюсь из‑за тебя.»", words: ["怒ってない", "ために", "お前", "俺は今"], correctOrder: [3, 2, 1, 0], explanationRu: "俺は今、お前のために怒ってない。" },
    ],
    grammarNotes: [
      {
        titleJa: "～ていない → ～てない",
        titleRu: "Разговорное сокращение ～てない",
        level: "N3",
        structure: "～ている → ～てる | ～ていない → ～てない | ～ではない → ～じゃない",
        explanationRu: "В разговорной речи い в конструкциях ～ている / ～ていない часто опускается: ～ている → ～てる, ～ていない → ～てない. Это не ошибка, а норма устного японского. Также ～ではない сокращается до ～じゃない, а ～てしまう до ～ちゃう. Понимание этих сокращений важно для восприятия аниме, дорам и живой речи.",
        examples: [
          { ja: "怒ってない。", furigana: "おこってない。", ru: "Не злюсь. (полная форма: 怒っていない)" },
          { ja: "まだ食べてない。", furigana: "まだ たべてない。", ru: "Ещё не ел. (полная форма: 食べていない)" },
          { ja: "知ってる？", furigana: "しってる？", ru: "Знаешь? (полная форма: 知っている？)" },
          { ja: "何してるの？", furigana: "なに してるの？", ru: "Что делаешь? (полная форма: 何をしているの？)" },
        ],
        tip: "В формальной письменной речи используйте полные формы (～ている). Сокращённые формы — только в разговоре и неформальном тексте.",
      },
      {
        titleJa: "誰も～ない",
        titleRu: "«Никто не…» — отрицание с 誰も",
        level: "N3",
        structure: "誰も + глагол в отрицательной форме",
        explanationRu: "Конструкция 誰も + отрицание означает «никто не делает». Аналогично работают другие вопросительные слова: 何も～ない (ничего не…), どこにも～ない (нигде не…), いつも～ない → 全然～ない. Важно: без отрицания 誰も означает «все/каждый» (誰もが知っている = все знают).",
        examples: [
          { ja: "誰も憎んじゃいない。", furigana: "だれ も にくんじゃいない。", ru: "Никого не ненавижу." },
          { ja: "誰も来なかった。", furigana: "だれ も こなかった。", ru: "Никто не пришёл." },
          { ja: "何も食べていません。", furigana: "なに も たべて いません。", ru: "Ничего не ел." },
          { ja: "どこにも行きたくない。", furigana: "どこ に も いきたくない。", ru: "Никуда не хочу идти." },
          { ja: "誰にも言わないでね。", furigana: "だれ に も いわないで ね。", ru: "Никому не говори, ладно?" },
        ],
        tip: "Схема: 誰も = никто, 何も = ничего, どこにも = нигде/никуда, いつも = никогда (с отрицанием → 全然～ない).",
      },
      {
        titleJa: "～ものだ",
        titleRu: "Так уж устроено / бывало (общая истина / ностальгия)",
        level: "N3",
        structure: "〔глагол-словарная форма / ない-форма〕＋ ものだ",
        explanationRu: "「～ものだ」имеет два основных значения. 1) Общая истина, «так уж устроено»: 人は変わるものだ (люди меняются — это нормально). 2) Ностальгия, «бывало»: 子供の頃、よく遊んだものだ (в детстве часто играл). В разговорной речи ものだ сокращается до もんだ. Это выражение добавляет эмоциональный оттенок — принятие, ностальгию или назидание.",
        examples: [
          { ja: "人は変わるものだ。", furigana: "ひと は かわる もの だ。", ru: "Люди меняются — так уж устроено." },
          { ja: "子供の頃、よく川で遊んだものだ。", furigana: "こども の ころ、よく かわ で あそんだ もの だ。", ru: "В детстве часто играл у реки." },
          { ja: "時間は早く過ぎるものだ。", furigana: "じかん は はやく すぎる もの だ。", ru: "Время летит быстро — вот как бывает." },
        ],
        tip: "ものだ с настоящим временем = общая истина. ものだ с прошедшим (～たものだ) = ностальгия. もんだ = разговорная форма.",
      },
    ],
  },
...
const LESSON_SORT: Record<string, number> = {
  ...
  "n5-narezki-mini-dialogue": 160,
  "n5-narezki-everyday-words": 165,
  ...
  "n4-chikawa-chaos": 70,
  "n4-narezki-short-story": 80,
  "n4-narezki-daily-life": 90,
  "n4-narezki-conversation": 100,
  ...
  "n3-narezki-quote": 90,
  "n3-narezki-interview": 100,
  "n3-narezki-discussion": 110,
